...
/*
 * ¿Es triángulo?
 * Programa que, al recibir como datos tres variables reales que representan los
 * lados de un probable triángulo, determina si esos lados corresponden a un
 * triángulo. En caso de serlo además de imprimir el área correspondiente
