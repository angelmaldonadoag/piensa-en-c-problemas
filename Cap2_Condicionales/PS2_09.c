...
int main(int argc, char* argv[])
{
	...
	switch(med)
	{
		case 1:
			...
			switch(sme)
			{
				case 1: res = val * 25.40; break;
				case 2: res = val * 0.9144; break;
				case 3: res = val * 1.6093; break;
				case 4: res = val * 6.452; break;
				case 5: res = val * 0.09290; break;
				case 6: res = val * 0.8361; break;
				case 7: res = val * 0.4047; break;
				case 8: res = val * 2.59; break;
				default:
					res = -1;
		...
		case 2:
			...
			switch(sme)
			{
				case 1: res = val * 0.02832; break;
				case 2: res = val * 0.7646; break;
				case 3: res = val * 0.56826; break;
				case 4: res = val * 4.54609; break;
				default:
					res = -1;
					printf("\nError en el tipo de conversion.\n");
					break;
		...
		case 3:
			...
			switch(sme)
			{
				case 1: res = val * 28.35; break;
				case 2: res = val * 0.45359; break;
				case 3: res = val * 1.0160; break;
				default:
					res = -1;
					printf("\nError en el tipo de conversion.\n");
					break;
