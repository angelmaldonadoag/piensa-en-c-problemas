 ...
 * entero, ordenados en forma ascendente, de N y M elementos respectivamente,
 * genera un nuevo arreglo unidimensinal ordenado en forma ascendente de N+M
 * elementos de tipo entero, mezclando los dos primeros.
